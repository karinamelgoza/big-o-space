...
// ANSWER: both depend on the length of the string 
...
console.log(noCacheCalcFac(8)/* CALL NOCACHECALCFAC PASSING IN 8*/)
console.log(noCacheCalcFac(8)/* CALL NOCACHECALCFAC PASSING IN 8*/)
console.log(noCacheCalcFac(8)/* CALL NOCACHECALCFAC PASSING IN 8*/)
console.log(noCacheCalcFac(8)/* CALL NOCACHECALCFAC PASSING IN 8*/)
...
console.log(myFac.calcFac(8)/* CALL THE CALCFAC METHOD OFF OF MYFAC 8*/)
console.log(myFac.calcFac(8)/* CALL THE CALCFAC METHOD OFF OF MYFAC 8*/)
console.log(myFac.calcFac(8)/* CALL THE CALCFAC METHOD OFF OF MYFAC 8*/)
console.log(myFac.calcFac(8)/* CALL THE CALCFAC METHOD OFF OF MYFAC 8*/)
